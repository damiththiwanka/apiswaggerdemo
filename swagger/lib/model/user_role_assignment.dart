...
class UserRoleAssignment {
  ...
  static List<UserRoleAssignment> listFromJson(List<dynamic> json) {
    return json == null ? new List<UserRoleAssignment>() : json.map((value) => new UserRoleAssignment.fromJson(value)).toList();
  }

  static Map<String, UserRoleAssignment> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, UserRoleAssignment>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new UserRoleAssignment.fromJson(value));
    }
    return map;
  }
}
