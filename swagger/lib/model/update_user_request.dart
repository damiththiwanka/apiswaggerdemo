...
;
  ...
  static List<UpdateUserRequest> listFromJson(List<dynamic> json) {
    return json == null ? new List<UpdateUserRequest>() : json.map((value) => new UpdateUserRequest.fromJson(value)).toList();
  }

  static Map<String, UpdateUserRequest> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, UpdateUserRequest>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new UpdateUserRequest.fromJson(value));
    }
    return map;
  }
}
