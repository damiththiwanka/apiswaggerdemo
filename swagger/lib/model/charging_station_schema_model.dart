...
class ChargingStationSchemaModel {
  ...
  ChargingStationSchemaModel.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    chargingStationCollectionId = json['charging_station_collection_id'];
...
// ;
  ...
  static List<ChargingStationSchemaModel> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<ChargingStationSchemaModel>()
        : json
            .map((value) => new ChargingStationSchemaModel.fromJson(value))
            .toList();
  }

  static Map<String, ChargingStationSchemaModel> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, ChargingStationSchemaModel>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new ChargingStationSchemaModel.fromJson(value));
    }
    return map;
  }
}
