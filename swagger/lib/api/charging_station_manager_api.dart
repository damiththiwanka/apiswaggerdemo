...
class ChargingStationManagerApi {
  ...
  ChargingStationManagerApi([ApiClient apiClient])
  ...
  Future<Object>
      createChargingStationSchemaChargingStationManagerCreateChargingStationSchemaPost(
          ChargingStationSchemaModel body,
    ...
    String path = "/charging-station-manager/create-charging-station-schema"
  ...
  Future<Object>
    ...
    // create path and map variables
    String path =
        "/charging-station-manager/get-all-charging-stations-with-evses"
            .replaceAll("{format}", "json");
  ...
  Future<Object>
    ...
    // create path and map variables
    String path = "/charging-station-manager/get-charging-station-devices"
        .replaceAll("{format}", "json");
  ...
  Future<Object>
    ...
    // create path and map variables
    String path = "/charging-station-manager/get-charging-station-eves-list"
        .replaceAll("{format}", "json");
  ...
  Future<Object>
    ...
    // create path and map variables
    String path = "/charging-station-manager/get-connector-devices"
        .replaceAll("{format}", "json");
    ...
    Map<String, String> formParams = {};
    queryParams.addAll(
        _convertParametersForCollectionFormat("", "connector_id", connectorId));
    headerParams["Authorization"] = authorization;
  ...
  Future<Object>
    ...
    // create path and map variables
    String path = "/charging-station-manager/get-eves-connector-list"
        .replaceAll("{format}", "json");
    ...
    Map<String, String> formParams = {};
    queryParams
        .addAll(_convertParametersForCollectionFormat("", "evse_id", evseId));
    headerParams["Authorization"] = authorization;
  ...
  ///
  /// Get Evse Devices
  Future<Object> getEvseDevicesChargingStationManagerGetEvesDevicesGet(
      String evseId,
      {String authorization}) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/charging-station-manager/get-eves-devices"
        .replaceAll("{format}", "json");
  ...
  Future<Object>
    ...
    // create path and map variables
    String path = "/charging-station-manager/register-charging-station"
        .replaceAll("{format}", "json");
