...
class CustomDropdown extends StatelessWidget {
  ...
  const CustomDropdown({Key ?key, required this.context, required this.value, required this.onChoose, required this.label, required this.items}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      style: TextStyle(color: colors.AppColors.primaryColorDark), //cor do texto ao digitar,
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          borderSide: BorderSide(
            color: colors.AppColors.primaryColorDark, //cor da borda
            width: 0.0
          ),
        ),
        hintStyle: TextStyle(
        ...
        border: OutlineInputBorder(
          borderSide: BorderSide(
            color: colors.AppColors.primaryColorDark, //cor da label quando esta com focus
            width: 0
          )
        ),
