...
class NewManufacture {
  ...
  static List<NewManufacture> listFromJson(List<dynamic> json) {
    return json == null ? new List<NewManufacture>() : json.map((value) => new NewManufacture.fromJson(value)).toList();
  }

  static Map<String, NewManufacture> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, NewManufacture>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new NewManufacture.fromJson(value));
    }
    return map;
  }
}
