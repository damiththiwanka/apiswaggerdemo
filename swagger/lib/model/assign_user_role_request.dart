...
class AssignUserRoleRequest {
  ...
  static List<AssignUserRoleRequest> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<AssignUserRoleRequest>()
        : json
            .map((value) => new AssignUserRoleRequest.fromJson(value))
            .toList();
  }

  static Map<String, AssignUserRoleRequest> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AssignUserRoleRequest>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new AssignUserRoleRequest.fromJson(value));
    }
    return map;
  }
}
