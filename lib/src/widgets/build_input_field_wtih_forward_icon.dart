...
class InputFieldWithForwardIcon extends StatelessWidget {
  final BuildContext context;
  final String value;
  final Function onChoose;
  final List<String> items;

  const InputFieldWithForwardIcon({Key ?key, required this.context, required this.value, required this.onChoose, required this.items}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
        ...
        decoration: InputDecoration(
            suffixIcon: Icon(Icons.keyboard_arrow_right_outlined, color: colors.AppColors.black,),
