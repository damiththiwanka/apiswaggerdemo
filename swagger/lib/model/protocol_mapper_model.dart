...
;
  ...
  static List<ProtocolMapperModel> listFromJson(List<dynamic> json) {
    return json == null ? new List<ProtocolMapperModel>() : json.map((value) => new ProtocolMapperModel.fromJson(value)).toList();
  }

  static Map<String, ProtocolMapperModel> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, ProtocolMapperModel>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new ProtocolMapperModel.fromJson(value));
    }
    return map;
  }
}
