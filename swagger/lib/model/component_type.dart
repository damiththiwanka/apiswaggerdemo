...
class ComponentType {
  ...
  ComponentType.fromJson(Map<String, dynamic> json) {
    ...
    evse = new EVSEType.fromJson(json['evse']);
  }

  Map<String, dynamic> toJson() {
    return {'name': name, 'instance': instance, 'evse': evse};
  }

  static List<ComponentType> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<ComponentType>()
        : json.map((value) => new ComponentType.fromJson(value)).toList();
  }

  static Map<String, ComponentType> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, ComponentType>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new ComponentType.fromJson(value));
    }
    return map;
  }
}
