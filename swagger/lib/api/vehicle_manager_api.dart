...
class VehicleManagerApi {
  ...
  VehicleManagerApi([ApiClient apiClient])
      : apiClient = apiClient ?? defaultApiClient;

  /// add_new_user_verhicle_vehicles_user_vehicle_post
  ///
  /// Add New User Verhicle
  Future<Object> addNewUserVerhicleVehiclesUserVehiclePost(NewVehicle body,
  ...
  Future<Object> addNewVehicleManufacturerVehiclesManufacturePost(
      NewManufacture body,
  ...
  Future<Object> addNewVehicleModelVehiclesModelPost(NewVehicleModel body,
      {String authorization, String contentType}) async {
    Object postBody = body;
  ...
  Future<Object> getAllVehicleListVehiclesAllModelsGet(
  ...
  Future<Object> getManufacturesListVehiclesManufacturesGet(
      {String authorization}) async {
    Object postBody = null;
  ...
  Future<Object> getModelsOfManufacturerVehiclesManufactureIdModelsGet(
    ...
    // create path and map variables
    String path = "/vehicles/{manufacture_id}/models"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "manufacture_id" + "}", manufactureId.toString());
  ...
  ///
  /// Get User Vehicles
  Future<Object> getUserVehiclesVehiclesUserIdGet(String userId,
      {String authorization}) async {
    Object postBody = null;
  ...
  ///
  /// Remove User Vehicle
  Future<Object> removeUserVehicleVehiclesVehicleIdDelete(String vehicleId,
      {String authorization}) async {
    Object postBody = null;
  ...
  ///
  /// Update User Vehicle
  Future<Object> updateUserVehicleVehiclesPut(UpdateUserVehicle body,
      {String authorization, String contentType}) async {
    Object postBody = body;
