...
class AvatarUpdateRequest {
  ...
  static List<AvatarUpdateRequest> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<AvatarUpdateRequest>()
        : json.map((value) => new AvatarUpdateRequest.fromJson(value)).toList();
  }

  static Map<String, AvatarUpdateRequest> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AvatarUpdateRequest>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new AvatarUpdateRequest.fromJson(value));
    }
    return map;
  }
}
