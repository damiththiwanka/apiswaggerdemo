...
;
  ...
  static List<CollectionBuilderModel> listFromJson(List<dynamic> json) {
    return json == null ? new List<CollectionBuilderModel>() : json.map((value) => new CollectionBuilderModel.fromJson(value)).toList();
  }

  static Map<String, CollectionBuilderModel> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CollectionBuilderModel>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new CollectionBuilderModel.fromJson(value));
    }
    return map;
  }
}
