...
;
    ...
    ;
    userRoles =
      UserRoleAssignment.listFromJson(json['user_roles'])
;
    serviceProviderId =
  ...
  static List<CreateNewUserRequest> listFromJson(List<dynamic> json) {
    return json == null ? new List<CreateNewUserRequest>() : json.map((value) => new CreateNewUserRequest.fromJson(value)).toList();
  }

  static Map<String, CreateNewUserRequest> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CreateNewUserRequest>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new CreateNewUserRequest.fromJson(value));
    }
    return map;
  }
}
