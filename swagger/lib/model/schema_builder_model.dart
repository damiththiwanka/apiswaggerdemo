...
class SchemaBuilderModel {
  ...
  SchemaBuilderModel.fromJson(Map<String, dynamic> json) {
    ...
    ;
    schemaComponents =
      SchemaItem.listFromJson(json['schema_components'])
;
    schemaProcesses =
...
;
  ...
  static List<SchemaBuilderModel> listFromJson(List<dynamic> json) {
    return json == null ? new List<SchemaBuilderModel>() : json.map((value) => new SchemaBuilderModel.fromJson(value)).toList();
  }

  static Map<String, SchemaBuilderModel> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, SchemaBuilderModel>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new SchemaBuilderModel.fromJson(value));
    }
    return map;
  }
}
