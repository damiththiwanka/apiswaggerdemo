...
class RegisterChargingStation {
  ...
  RegisterChargingStation.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    chargingStationSchemaId = json['charging_station_schema_id'];
//     chargingStationData =
//
//
...
// ;
  ...
  static List<RegisterChargingStation> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<RegisterChargingStation>()
        : json
            .map((value) => new RegisterChargingStation.fromJson(value))
            .toList();
  }

  static Map<String, RegisterChargingStation> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RegisterChargingStation>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new RegisterChargingStation.fromJson(value));
    }
    return map;
  }
}
