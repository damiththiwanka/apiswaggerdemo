...
;
  ...
  static List<ObjectBuilderModel> listFromJson(List<dynamic> json) {
    return json == null ? new List<ObjectBuilderModel>() : json.map((value) => new ObjectBuilderModel.fromJson(value)).toList();
  }

  static Map<String, ObjectBuilderModel> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, ObjectBuilderModel>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new ObjectBuilderModel.fromJson(value));
    }
    return map;
  }
}
