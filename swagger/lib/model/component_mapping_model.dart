...
;
  ...
  static List<ComponentMappingModel> listFromJson(List<dynamic> json) {
    return json == null ? new List<ComponentMappingModel>() : json.map((value) => new ComponentMappingModel.fromJson(value)).toList();
  }

  static Map<String, ComponentMappingModel> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, ComponentMappingModel>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new ComponentMappingModel.fromJson(value));
    }
    return map;
  }
}
