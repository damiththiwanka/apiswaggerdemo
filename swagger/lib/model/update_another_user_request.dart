...
;
  ...
  static List<UpdateAnotherUserRequest> listFromJson(List<dynamic> json) {
    return json == null ? new List<UpdateAnotherUserRequest>() : json.map((value) => new UpdateAnotherUserRequest.fromJson(value)).toList();
  }

  static Map<String, UpdateAnotherUserRequest> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, UpdateAnotherUserRequest>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new UpdateAnotherUserRequest.fromJson(value));
    }
    return map;
  }
}
