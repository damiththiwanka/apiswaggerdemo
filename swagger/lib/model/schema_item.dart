...
;
  ...
  static List<SchemaItem> listFromJson(List<dynamic> json) {
    return json == null ? new List<SchemaItem>() : json.map((value) => new SchemaItem.fromJson(value)).toList();
  }

  static Map<String, SchemaItem> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, SchemaItem>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new SchemaItem.fromJson(value));
    }
    return map;
  }
}
